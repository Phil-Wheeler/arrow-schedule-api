...
{
    /// <inheritdoc />
    public partial class FixLocationServiceRelationship : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationService", x => new { x.LocationsId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_LocationService_Locations_LocationsId",
